...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics
	{
		struct _Script_CoinPusher_eventCoinValueChanged_Parms
		{
			int32 nCurrCoins;
		};
		static const UECodeGen_Private::FIntPropertyParams NewProp_nCurrCoins;
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::NewProp_nCurrCoins = { "nCurrCoins", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_CoinPusher_eventCoinValueChanged_Parms, nCurrCoins), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::NewProp_nCurrCoins,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "PoollingComp.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_CoinPusher, nullptr, "CoinValueChanged__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::_Script_CoinPusher_eventCoinValueChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::_Script_CoinPusher_eventCoinValueChanged_Parms) < MAX_uint16);
	UFunction* Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FCoinValueChanged_DelegateWrapper(const FMulticastScriptDelegate& CoinValueChanged, int32 nCurrCoins)
{
	struct _Script_CoinPusher_eventCoinValueChanged_Parms
	{
		int32 nCurrCoins;
	};
	_Script_CoinPusher_eventCoinValueChanged_Parms Parms;
	Parms.nCurrCoins=nCurrCoins;
	CoinValueChanged.ProcessMulticastDelegate<UObject>(&Parms);
}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CoinAmountUpdated_MetaData[];
#endif
		static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_CoinAmountUpdated;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPoollingComp_Statics::NewProp_CoinAmountUpdated_MetaData[] = {
		{ "ModuleRelativePath", "PoollingComp.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPoollingComp_Statics::NewProp_CoinAmountUpdated = { "CoinAmountUpdated", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPoollingComp, CoinAmountUpdated), Z_Construct_UDelegateFunction_CoinPusher_CoinValueChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPoollingComp_Statics::NewProp_CoinAmountUpdated_MetaData), Z_Construct_UClass_UPoollingComp_Statics::NewProp_CoinAmountUpdated_MetaData) }; // 3320840167
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPoollingComp_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPoollingComp_Statics::NewProp_CoinAmountUpdated,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ENG02_GDENG02_ProjectsRepo_03_CoinPusher_CoinPusher_Source_CoinPusher_PoollingComp_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPoollingComp, UPoollingComp::StaticClass, TEXT("UPoollingComp"), &Z_Registration_Info_UClass_UPoollingComp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoollingComp), 21175106U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ENG02_GDENG02_ProjectsRepo_03_CoinPusher_CoinPusher_Source_CoinPusher_PoollingComp_h_203790112(TEXT("/Script/CoinPusher"),
