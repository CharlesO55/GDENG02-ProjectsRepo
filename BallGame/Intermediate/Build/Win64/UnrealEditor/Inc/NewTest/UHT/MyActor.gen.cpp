...
#include "NewTest/MyActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	NEWTEST_API UClass* Z_Construct_UClass_AMyActor();
	NEWTEST_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
...
// End Cross Module References
	...
	template<> NEWTEST_API UClass* StaticClass<AMyActor>()
	{
		return AMyActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMyActor);
	AMyActor::~AMyActor() {}
	struct Z_CompiledInDeferFile_FID_ENG02_NewTest_Source_NewTest_MyActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ENG02_NewTest_Source_NewTest_MyActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMyActor, AMyActor::StaticClass, TEXT("AMyActor"), &Z_Registration_Info_UClass_AMyActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyActor), 3579410929U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ENG02_NewTest_Source_NewTest_MyActor_h_3267298070(TEXT("/Script/NewTest"),
		Z_CompiledInDeferFile_FID_ENG02_NewTest_Source_NewTest_MyActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ENG02_NewTest_Source_NewTest_MyActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
